...
class BrowserHistory extends Component {
  state = {searchHistory: '', historyList: initialHistoryList}
  ...
  render() {
    ...
    const filteredHistory = historyList.filter(eachItem =>
      eachItem.title.toLowerCase().includes(searchHistory.toLowerCase()),
    )
      ...
      <div className="main">
        <div className="history-tab">
          <img
            ...
            alt="app logo"
          />
          <div className="history-search-con">
            <img
